...
real_time_data_buffer = deque()

def set_data(request):
    real_time_data_buffer.append(int(request.GET['real_time_data']))
    return HttpResponse("ok")

def get_data(request):
    response_data = {}
    if real_time_data_buffer : 
        response_data['new_data'] = real_time_data_buffer.popleft()
    else :
